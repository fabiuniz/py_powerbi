...
categorization_rules = {
    ...
    'IMPRESSORA': [r'PONTODOSCAr', r'PRODATA' ],
    ...
    'MERCADO': [
        ...
        r'MERCADINHO', r'PANIF', r'PADARIA', r'CARREFOUr', r'BIG BOM', r'MERCADO ', r'MARCO', r'MUFFATO', r'GIGA ATACADO', r'DIA BRASIL',
    ...
    'OUTROS': [
        r'EDUARDODIAS', r'EDUARDO', r'KEVERSON', r'LUCASDASILVA', r'RODRIGODEJES', r'SANDRAREGINA', 
    ...
    'RESTAURANTE': [
        r'FRIENDS', r'BACON', r'CHURRAS', r'BURGEr', r'ESFIHA', r'DOGDODIE', r'JIN JIN', r'MP CALDODE', r'MEI MEI', r'EXPRESS GRI', r'MARIVANLIMA',
        ...
        r'MP ALE', r'PRA LA DE BO', r'NIPPON', r'ASSB COMERC', r'ANDREGRE', r'ATMK COM DE',r'JARDIM DAS'
    ],
    'SAQUE': [r'SAQUE', r'CXE'],
    ...
    'SHOPPING': [
        ...
        r'DMW COMERCIO',  r'AUTTAR LOJA', r'GSMMYCOMERC', r'MAG 1 CENTr', r'SERRANA', r'UNISO IBIRA', 
...
file_paths = [
        '../../../../Doc/Docs/Extratos/extrato_082026_260901_102249.txt',  # 08/26 a 09/26
