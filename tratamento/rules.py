...
categorization_rules = {
        ...
        'MERCADO': [r'SUP CERCADAO',r'OXXO',r'PAO DE AC',r'MiniMercado',r'SUPERM',r'MERCEARIA',r'CHOCOLANDIA',r'EXTRA HIPER',r'ATACAD[AÃ]O',r'MERCADINHO',r'PANIF',r'PADARIA',r'CARREFOUR', r'RSHOP BIG BOM', r'RSHOP MERCADO ', r'RSHOP MARCO', r'RSHOP MUFFATO', r'SUPERMERCADO', r'RSHOP-MERCADO'],
        'MATERIAL' :[r'TINTAS'],
